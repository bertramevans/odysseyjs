      ...
      1: [
        function (_dereq_, module, exports) {
          ...
          function open(el, items, _class, offset) {
            ...
            if (
              d3.select("#actionDropdown").node().offsetHeight +
                h -
                d3.select("#editor_modal").node().offsetHeight >
              120
            ) {
              var top_ =
                h -
          ...
          function dialog(context) {
            ...
            function _dialog(el) {
              var codeEditor = el.selectAll("textarea#code").data([code]);

              var enter = codeEditor.enter();
              var divHeader = enter.append("div").attr("class", "header");
              var divOptions = enter.append("div").attr("class", "options");
              ...
              divHeader.append("h1").text("Odyssey sandbox");

              var templates = context.templates().map(function (d) {
                  return d.title;
                }),
              ...
              selector
                ...
                .attr(
                  "src",
                  "https://cartocdn_a.global.ssl.fastly.net/base-light/6/30/24.png"
                )
                .attr("alt", "");
              ...
              selector.on("click", function () {
                ...
                open(
                  this,
                  context.basemaps().map(function (d) {
                    return (
                      '<img src="' +
                      d.thumbnail +
                      '" alt="" /><span>' +
              ...
              divHeader
                ...
                .on("click", function (d) {
                  ...
                  d3.select(document.body).call(
                    Splash(context).on("template", function (t) {
                      evt.template(t);
                    })
                  );
              ...
              var actions_bar = enter.append("div").attr("id", "actions_bar");
              ...
              textarea.each(function () {
                var codemirror = (this.codemirror = CodeMirror.fromTextArea(
                  this,
                  {
                    mode: "markdown",
                    lineWrapping: true,
                ...
                var showActions = debounce(function () {
                  placeActionButtons(codemirror_wrap, codemirror);
                }, 500);
                var hideActions = debounce(function () {
              ...
              context.on("error.editor", function (errors) {
                ...
                e.enter().append("div").attr("class", "error");
                e.text(String);
              ...
              for (var i = slideNumer + 1; i < codemirror.lineCount(); ++i) {
                ...
                if (ACTIONS_BLOCK_REGEXP.exec(line)) {
                  if (++c === 2) {
                    ...
                    var slideActions = O.Template.parseProperties(
                      getLines(codemirror, blockStart, i)
                    );
                    var updatedActions = {};
                    ...
                    for (var k in updatedActions) {
                      for (
                        var linePos = blockStart + 1;
                        linePos < i;
                        ++linePos
                      ) {
                        if (
                          k in
                          O.Template.parseProperties(
                            codemirror.getLine(linePos)
                          )
                        ) {
            ...
            function placeActionButtons(el, codemirror) {
              ...
              var buttons = el.selectAll(".actionButton").data(positions);
      ...
      3: [
        function (_dereq_, module, exports) {
          function relocateAssets(doc) {
            ...
            for (var i = 0; i < js.length; ++i) {
              ...
              if (src && src.indexOf("http") !== 0) {
                js[i].setAttribute(
                  "src",
                  (relocate_url + src).replace(/sandbox\/..\//g, "")
                );
              }
            }
          ...
          function processHTML(html, md, transform) {
            ...
            return (
              "<!doctype><html>" + doc.documentElement.innerHTML + "</html>"
            );
          }
        ...
        function (_dereq_, module, exports) {
          ...
          var TEMPLATE_LIST = [
            ...
            },
            {
              title: "torque",
              description:
                "Link story elements to moments in time using this animated map template",
              default:
                '```\n-baseurl: "https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}.png"-title: "Title"\n-author: "Odyssey.js Developers"\n-vizjson: "https://viz2.cartodb.com/api/v2/viz/521f3768-eb3c-11e3-b456-0e10bcd91c2b/viz.json"\n-duration: 18\n```\n\n# Torque Template\n```\n- step: 0\n- center: [-4.0396, 5.5371]\n- zoom: 2\n```\n\n## Animated maps in Odyssey.js\n\nDelete the [Markdown](https://daringfireball.net/projects/markdown/) to get started with your own or watch this story to learn some of the techniques.\n\n# vizjson\n```\n-step: 30\nS.torqueLayer.actions.pause()\nO.Actions.Sleep(3000)\nS.torqueLayer.actions.play()\n```\n\nUnlike other Odyssey.js templates, the Torque template requres a Viz.JSON URL to add an animated layer to your map. You can find out more about Viz.JSON URLs [here](https://developers.cartodb.com/documentation/using-cartodb.html#sec-8)\n\nTo add your own, just replace the above link so it looks like,\n\n**-vizjson: "https://your-url/viz.json"**\n\n\n# Markdown\n```\n-step: 60\nS.torqueLayer.actions.pause()\nO.Actions.Sleep(3000)\nS.torqueLayer.actions.play()\n```\n\nLike all templates, the Torque template runs on [Markdown](https://daringfireball.net/projects/markdown/). This gives you the ability to create completely custom content for your story\n\n# Change map position \n```\n- step: 111\n- center: [50.2613, -2.1313]\n- zoom: 5\nS.torqueLayer.actions.pause()\nO.Actions.Sleep(3000)\nS.torqueLayer.actions.play()\n```\n\nYou can tour the map by:\n\n1. Add a new section using the headline notation, **#**\n2. Pause the slider and move it to the desired time in your map visualization.\n3. Beside your new headline, click Add and then **insert time**\n4. Move your map to your desired location, and click "move map to current position"\n\n# Pause your map\n```\n- step: 292\n- center: [9.4165, -79.2828]\n- zoom: 7\nS.torqueLayer.actions.pause()\nO.Actions.Sleep(2000)\nS.torqueLayer.actions.play()\n```\n\nIf you want to highlight a particular moment in time, it is helpful to use a Pause, Sleep, Play series of events like this slide. \n',
            },
          ];
          ...
          var BASEMAP_LIST = [
            ...
            },
            {
              ...
              thumbnail:
                "https://2.maps.nlp.nokia.com/maptile/2.1/maptile/newest/normal.day/6/30/24/256/png8?lg=eng&token=A7tBPacePg9Mj_zghvKt9Q&app_id=KuYppsdXZznpffJsKT24",
            },
            {
              title: "Stamen Watercolor",
              url: "https://{s}.tile.stamen.com/watercolor/{z}/{x}/{y}.jpg",
              thumbnail: "https://a.tile.stamen.com/watercolor/6/30/24.jpg",
            },
          ];
          ...
          function editor(callback) {
            ...
            d3.rebind(
              context,
              d3.dispatch("error", "template_change"),
              "on",
              "error",
              "template_change"
            );
            ...
            context.templates = function (_) {
              if (_) {
                var t = TEMPLATE_LIST.map(function (d) {
                  return d.title;
                }).indexOf(_);
                if (t >= 0) {
            ...
            context.basemaps = function (_) {
              if (_) {
                var t = BASEMAP_LIST.map(function (d) {
                  return d.title;
                }).indexOf(_);
                if (t >= 0) {
            ...
            code_dialog.on("code.editor", function (code) {
              if (code.indexOf("baseurl:") != -1) {
                ...
                var urls = context.basemaps().map(function (d) {
                  return d.url;
                });
      ...
      5: [
        function (_dereq_, module, exports) {
          function share_dialog(url, html_url) {
            ...
            // toggle iframe url
            s.selectAll("#mode_menu a").on("click", function () {
              d3.event.preventDefault();
            ...
            s.selectAll("#closeButton").on("click", function () {
              d3.event.preventDefault();
              close();
            });
        ...
        function (_dereq_, module, exports) {
          function Splash(context) {
            ...
            function _splash() {
              ...
              var inner_content = div
                .append("div")
                .attr("class", "splash_inner");
              ...
              var templates = inner_content
                .append("ul")
                .attr("class", "template_list h-valign");
              ...
              template.append("p").text(function (d) {
          ...
          var saveAs =
            ...
            (function (view) {
              ...
              var doc = view.document,
                ...
                can_use_save_link =
                  !view.externalHost && "download" in save_link,
                click = function (node) {
